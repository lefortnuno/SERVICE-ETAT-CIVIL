...
export default function ModalEdition(props) {
  ...
  const [messages, setMessages] = useState({
    idProfession: "",
    nomProfession: "Nom de l'Profession obligatoire",
      ...
      >
        <Modal.Header>
          <Modal.Title className="text-primary h5 md-4">
            Edition Profession : {identifiant}
          </Modal.Title>
        </Modal.Header>
          ...
          <Form>
            ...
            >
              <Form.Control
                ...
                placeholder="Identifiant de l'Profession"
                autoComplete="off"
                autoFocus
                disabled={true}
                hidden={true}
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
              ...
              <Form.Control
                ...
                placeholder="Nom de l'Profession"
                autoComplete="off"
                autoFocus
              />
              <small className="text-danger d-block">
                {erreurs.nomProfession ? messages.nomProfession : null}
              </small>
              <small className="text-danger d-block">
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            onClick={(e) => validation(e, inputs.idProfession)}
          >
            Enregistrer
          </Button>
        </Modal.Footer>
